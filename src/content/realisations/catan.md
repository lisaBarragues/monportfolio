...
<img style="float:center; margin: 1.5rem 0 0 1.5rem;border-radius: 8px; height:500px; width:700px;" src="/images/realisations/catan/catangameplay.png" alt="catangameplay"/>
...
Pour moi, cette réalisation a considérablement renforcé mes compétences en **[Java](/competences/java)** et en **POO** et m'a également permis de développer des compétences importantes en **gestion de projet** et en **[travail d'équipe](/competences/esprit-equipe)**. Sur le plan technique, j'ai approfondi ma maîtrise de **Java**, notamment l'utilisation de l'**héritage**, des **interfaces** et des **classes internes**. Sur le plan humain, il m'a appris à m'**[organiser](/competences/organisation)** sur la durée, à **[communiquer](/competences/communication)** efficacement avec ma binôme et à résoudre des problèmes techniques de manière collaborative.
