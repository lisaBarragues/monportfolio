...
<img style="float:center; margin: 0 0 1rem 1.5rem; border-radius: 8px; height:500px; width:750px;" src="/images/realisations/myplatformer/myplatformer.gif" alt="myplatformer"/> 
...
Ma principale valeur ajoutée sur ce projet a été la **conception** et l'**implémentation des mécaniques de jeu côté joueur** avec la gestion des entrées clavier, la physique du saut et le système de collisions. J'ai dû **résoudre des problèmes concrets**, comme la distinction entre collisions horizontales et verticales, qui m'ont vraiment forcé à réfléchir à la **logique du programme** plutôt qu'à simplement écrire du code.
